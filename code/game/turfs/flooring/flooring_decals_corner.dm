...
// ----------------- Wide corners
// Works better with some kinds of floors when you want the line of corner decals to connect
...
// ----------------- Full corners
// If you ever need just a little more reach. Maybe for linoleum.
